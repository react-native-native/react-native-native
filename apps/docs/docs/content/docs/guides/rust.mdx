---
title: Rust
description: Write native components and functions in Rust.
---
...
```bash
npx @react-native-native/cli setup-rust
```
...
Props are automatically converted from camelCase in JS to snake_case in Rust.
