...
3. **Creates `Cargo.toml`** — sets up a project-root `Cargo.toml` with the `rna-core` dependency. This is where you add additional Rust dependencies with `cargo add`
